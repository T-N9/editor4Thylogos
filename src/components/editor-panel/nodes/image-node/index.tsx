...
export function $createImageNode({
  ...
  // Initialize localState to false by default
  let localState = null;
  ...
  if (typeof window !== 'undefined') {
    ...
    localState = localStorageKey ? JSON.parse(localStorageKey) : false;
  }
  ...
  return $applyNodeReplacement(
    new ImageNode(
      src,
      altText,
      maxWidth = localState ? parseInt(contentSizers[localState.contentSize].size) - 60 : 1350,
      width,
      height,
      showCaption,
      caption,
