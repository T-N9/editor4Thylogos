...
const FONT_FAMILY_OPTIONS: {
  ...
  type?: BlockTypeOptions;
    ...
    { info: [`BurmeseHandwriting`, 'BurmeseHandwriting'], lang: LanguageOptions.MM, type: BlockTypeOptions.WRITING },
    ...
    { info: [`Lakwel`, 'Lakwel'], lang: LanguageOptions.MM, type: BlockTypeOptions.WRITING },
    { info: [`YayChanZin`, 'YayChanZin'], lang: LanguageOptions.MM, type: BlockTypeOptions.WRITING },
    { info: [`MyanmarSanPya`, 'MyanmarSanPya'], lang: LanguageOptions.MM},
    { info: [`Yunghkio`, 'Yunghkio'], lang: LanguageOptions.MM},
    { info: [`YoeYarOne`, 'YoeYarOne'], lang: LanguageOptions.MM, type: BlockTypeOptions.WRITING },
    { info: ['Arial', 'Arial'] },
