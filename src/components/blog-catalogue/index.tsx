                    ...
                    <div key={index} className='relative border p-3 rounded-md'>
                        {
                            ...
                            <>
                                <Button href={`/blog/${blog.slug}`} as={Link} type='button' isIconOnly size='sm' className='absolute right-12 top-2 bg-orange-500'>
                                ...
                                <Button href={`/manage/update/${blog.slug}`} as={Link} type='button' isIconOnly size='sm' className='absolute right-2 top-2 bg-blue-500'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#fff" className="size-4">
