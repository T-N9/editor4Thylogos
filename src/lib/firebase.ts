...
export const fetchDraftedBlogDataById = async (id: string) => {
  console.log('DraftedBlogDataBySlug', id);
  try {
...
export const fetchDraftedBlogDataBySlug = async (slug: string) => {
  console.log('DraftedBlogDataBySlug', slug);
  try {
