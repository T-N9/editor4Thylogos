                ...
                blogData.map((blog, index) => (
                    <div key={index} className='relative'>
                        <Link href={`/update/${blog.slug}`}>
                            <button className='absolute p-1 right-2 top-2 bg-blue-500 rounded-full shadow'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#fff" className="size-4">
