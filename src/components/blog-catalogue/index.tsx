        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
            {
                fetchedBlogData?.map((blog, index) => (
                    <div key={index} className='relative border p-3 rounded-md'>
                        <Button href={`/update/${blog.slug}`} as={Link} type='button' isIconOnly size='sm' className='absolute right-2 top-2 bg-blue-500'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#fff" className="size-4">
