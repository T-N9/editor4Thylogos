    ...
    return (
        <>
            <LexicalComposer initialConfig={initialConfig}>
                <main className={`flex editor-shell mx-auto pt-8 rounded-sm 2xl:max-w-[1440px] max-w-[1300px] 2xl:w-[1440px] lg:w-[1300px] flex-col gap-2 text-gray-700 dark:text-gray-300 relative leading-7 font-normal justify-center px-2.5`}>
                    <div className="">
